...
def slice_image(info,sim):
    ...
    casefoam = OpenFOAMReader(
        FileName='C:\\Users\\fitir\\Desktop\\Paraview_Batch_Postproc\\Case_Files\\Prueba de paraview\\case.foam')
    casefoam.MeshRegions = ['internalMesh']
    casefoam.CellArrays = ['U', 'k', 'nut', 'omega', 'p', 'wallShearStress', 'yPlus']

    # find source
    mFT02_311C1402CARstl = FindSource('MFT02_311-C1-402-CAR.stl')
